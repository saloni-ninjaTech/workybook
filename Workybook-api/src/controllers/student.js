...
module.exports = {
    ...
    create: async (req, res, next) => {
        try {
            ...
            if (params.password) { 
                //params.password ='Student@123' 
                params.showPassword = params.password
        ...
        try {
            ...
            if (params.students && params.students.length) {
                await Promise.all(params.students.map(async (oneStudent) => {
                    ...
                    oneStudent.userName = await createUserName(`${oneStudent.firstName}.${oneStudent.lastName}`)
                    ...
                    oneStudent.password ='Student@123' 
                    oneStudent.showPassword = oneStudent.password
                    oneStudent.password = await generateHashValue(oneStudent.password)
